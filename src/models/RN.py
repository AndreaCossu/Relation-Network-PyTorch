...
class RelationNetwork(nn.Module):
    ...
    def __init__(self, object_dim, hidden_dims_g, output_dim_g, hidden_dims_f, output_dim_f, batch_size, device):
        ...
        # object_dim debería ser 2048, porque debería recibir las features de los objetos de Faster 
        # output_dim_f debería ser la cantidad de respuestas posibles
        # query es la pregunta 
